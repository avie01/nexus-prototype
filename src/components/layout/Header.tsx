    ...
    <header className="bg-white border-b border-gray-200/80" style={{ borderTop: '4px solid #3560C1' }}>
      <div className="flex items-center justify-between px-3 py-3">
        ...
        <div className="flex items-center space-x-5">
          <BellIcon size={20} className="text-gray-500 hover:text-gray-700" />
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-full bg-green-700 text-white flex items-center justify-center text-sm font-normal">
              SM
            </div>
